...
(function() {
    ...
    var n = {
        ...
        GA: "UA-59663620-1",
        SHARE_IMG: "/facebook_wildflower2.png"
    };
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    }("undefined" != typeof module && module.exports && "undefined" != typeof global ? global : this || window, "TweenMax"), define("TweenMax", function() {}), define("view/preloader", ["jquery", "underscore", "view/common/base_view", "data/drop", "TweenMax"], function(e, t, n, r, i) {
    return n.extend({
        instance: null,
        ctx0: null,
        ctx1: null,
        ...
        show: function() {
            i.to(this.$loader_canvas, 0, {
                opacity: 0
            }), i.to(this.$loader_canvas, 2, {
                opacity: 1,
                delay: 1,
        ...
        colorAnimate: function() {
            i.to(this.$can0, .75, {
                ...
                opacity: .4,
                onComplete: this.colorAnimateBack,
                ease: Power0.easeInOut
            })
        },
